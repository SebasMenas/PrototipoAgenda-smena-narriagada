...
def inicializar_db():
    ...
    if cursor.fetchone()[0] == 0:
        usuarios_prueba = [
            ...
            ('dlopez', 'doc123', 'Dra. María', 'López', '11111111-1', 'Mujer', 'DOCTOR'),
            ('pperez', 'doc456', 'Dr. Pedro', 'Pérez', '22222222-2', 'Hombre', 'DOCTOR'),
            ('dyimi', 'doc789', 'Dr. Yimi', 'Desconocido', '33333333-3', 'Hombre', 'DOCTOR'),
